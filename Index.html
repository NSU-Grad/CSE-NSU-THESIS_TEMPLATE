            ...
            <div class="d-flex flex-row justify-content-center">
              ...
              <div class="text text-center">
                <h3 class="pt-1 m-0">MS WORD</h3>
                 ...
                 <a href="files/NSU_Thesis_Template.docx">Download MS Template</a> <p style=" margin-bottom: 0rem; color: gray; font-size: 1.5vmin">Total downlaods: <?php echo get_download_count('NSU_Thesis_Template.docx');?></p>
          ...
          <div class="desktop shadow-lg">
            <div class="d-flex flex-row justify-content-center">
              ...
              <div class="text text-center">
                ...
                <a href="files/NSU Thesis Template.zip">Download as Zip</a> <p style="margin-bottom: 0rem; color: gray; font-size: 1.5vmin">Total downloads: <?php echo get_download_count('NSU Thesis Template.zip');?></p>
